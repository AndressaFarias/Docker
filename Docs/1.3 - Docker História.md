...
A imagem é como se fosse uma receita de bolo.
Uma série de instruções que o Docker seguirá para criar um container. 
Criado o container, o Docker executa-o.

Quando efetuamos o download de uma imagem é possivel verificar que ela é composta por várias camadas (_layers_).
